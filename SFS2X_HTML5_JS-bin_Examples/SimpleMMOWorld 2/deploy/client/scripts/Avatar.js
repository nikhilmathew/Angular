(function (window) {
	...
	/**
	 * Updates the counter of opened barrels.
	 */
	Avatar.prototype.setBarrelsCounter = function (count)
	{
		// Remove previous text (if any)
		var text = this.getChildByName("counter");
		if (text != null)
			this.removeChild(text);

		// Show new text
		text = new createjs.Text(count + " collected", "8px Arial", "#666666");
        text.textAlign ="center";
		text.name = "counter";
        text.y = 14;
        text.x = 0;
